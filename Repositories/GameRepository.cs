        ...
        public GameRepository(ICompanyRepository repository, IConfiguration configuration)
        {
            ...
            games = new List<Game> {
                ...
                new Game {
                    ...
                    Name = "Mega-Man",
                    Image = $"{_configuration["baseUrl"]}images/megaman.jpg",
                    CompanyId = capcom.Id,
                    Company = capcom
                },
                new Game {
                    ...
                    Name = "Resident Evil",
                    Image = $"{_configuration["baseUrl"]}images/resident-evil.png",
                    CompanyId = capcom.Id,
                    Company = capcom
                },
                new Game {
                    ...
                    Name = "Street Fight",
                    Image = $"{_configuration["baseUrl"]}images/street-fighter-2.jpg",
                    CompanyId = capcom.Id,
                    Company = capcom
                },
                new Game {
                    ...
                    Name  = "FIFA",
                    Image = $"{_configuration["baseUrl"]}images/fifa.jpg",
                ...
                new Game {
                    ...
                    Name = "Need For Speed",
                    Image = $"{_configuration["baseUrl"]}images/need-for-speed.jpg",
                    CompanyId = easports.Id,
                    Company = easports
                },
                new Game {
                    ...
                    Name = "Castlevania",
                    Image = $"{_configuration["baseUrl"]}images/castlevania.jpg",
                    CompanyId = konami.Id,
                    Company = konami
                },
                new Game {
                    ...
                    Name = "Metal Gear",
                    Image = $"{_configuration["baseUrl"]}images/metalgear.jpg",
                    CompanyId = konami.Id,
                    Company = konami
                },
                new Game {
                    ...
                    Image = $"{_configuration["baseUrl"]}images/pro-evolution-soccer.jpg",
                    CompanyId = konami.Id,
                    Company = konami
                }
            };
